...
//            if (!context.ExperienceCategories.Any())
//            {
//                var categories = new List<ExperienceGroup>
//                {
...
//                    new ExperienceGroup { Name = "Akut barsels Konsultation" },
//                    new ExperienceGroup { Name = "forældre konsultation" 
//                };
...
//               var Fødsel = context.ExperienceCategories.Single(e => e.Id == 1);
//               var Konsultation  = context.ExperienceCategories.Single(e => e.Id == 2);
//               var Modtagelse = context.ExperienceCategories.Single(e => e.Id == 3);
//               var UdvendigUndersøgelse = context.ExperienceCategories.Single(e => e.Id == 4);
//               var BarselsKonsultation = context.ExperienceCategories.Single(e => e.Id == 5);
//               var ForældreKonsultation = context.ExperienceCategories.Single(e => e.Id == 6);
